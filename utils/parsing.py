...
def parse_train_args():
    ...
    parser.add_argument('--save_model', type=str, default = 'workdir/contrastive/2024-09-27-07-49-37/save_best_model_0.pt',help='model for test or restart training')
    ...
    parser.add_argument('--batch_size', type=int, default=48, help='Batch size on each gpu')
    ...
    parser.add_argument('--pct_start', type=float, default=0.2, help='OneCycleLR parameter')
    parser.add_argument('--num_workers', type=int, default=6, help='Number of workers for preprocessing')
    # Model
